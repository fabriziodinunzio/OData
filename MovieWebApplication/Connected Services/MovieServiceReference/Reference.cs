...
namespace MovieWebApplication.MovieServiceReference {
    ...
    public interface IMovieService {
        ...
        MovieWebApplication.MovieServiceReference.Movie[] GetMovies();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovieService/GetMovies", ReplyAction="http://tempuri.org/IMovieService/GetMoviesResponse")]
        System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie[]> GetMoviesAsync();
        ...
        MovieWebApplication.MovieServiceReference.Movie[] GetMoviesByTitle(string title);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovieService/GetMoviesByTitle", ReplyAction="http://tempuri.org/IMovieService/GetMoviesByTitleResponse")]
        System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie[]> GetMoviesByTitleAsync(string title);
        ...
        MovieWebApplication.MovieServiceReference.Movie GetMovie(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovieService/GetMovie", ReplyAction="http://tempuri.org/IMovieService/GetMovieResponse")]
        System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie> GetMovieAsync(int id);
        ...
        MovieWebApplication.MovieServiceReference.Review[] GetReviews(int movieId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovieService/GetReviews", ReplyAction="http://tempuri.org/IMovieService/GetReviewsResponse")]
        System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Review[]> GetReviewsAsync(int movieId);
        ...
        void SubmitReview(int movieId, MovieWebApplication.MovieServiceReference.Review review);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovieService/SubmitReview", ReplyAction="http://tempuri.org/IMovieService/SubmitReviewResponse")]
        System.Threading.Tasks.Task SubmitReviewAsync(int movieId, MovieWebApplication.MovieServiceReference.Review review);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMovieServiceChannel : MovieWebApplication.MovieServiceReference.IMovieService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MovieServiceClient : System.ServiceModel.ClientBase<MovieWebApplication.MovieServiceReference.IMovieService>, MovieWebApplication.MovieServiceReference.IMovieService {
        ...
        public MovieWebApplication.MovieServiceReference.Movie[] GetMovies() {
            return base.Channel.GetMovies();
        }
        
        public System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie[]> GetMoviesAsync() {
            return base.Channel.GetMoviesAsync();
        }
        
        public MovieWebApplication.MovieServiceReference.Movie[] GetMoviesByTitle(string title) {
            return base.Channel.GetMoviesByTitle(title);
        }
        
        public System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie[]> GetMoviesByTitleAsync(string title) {
            return base.Channel.GetMoviesByTitleAsync(title);
        }
        
        public MovieWebApplication.MovieServiceReference.Movie GetMovie(int id) {
            return base.Channel.GetMovie(id);
        }
        
        public System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Movie> GetMovieAsync(int id) {
            return base.Channel.GetMovieAsync(id);
        }
        
        public MovieWebApplication.MovieServiceReference.Review[] GetReviews(int movieId) {
            return base.Channel.GetReviews(movieId);
        }
        
        public System.Threading.Tasks.Task<MovieWebApplication.MovieServiceReference.Review[]> GetReviewsAsync(int movieId) {
            return base.Channel.GetReviewsAsync(movieId);
        }
        
        public void SubmitReview(int movieId, MovieWebApplication.MovieServiceReference.Review review) {
            base.Channel.SubmitReview(movieId, review);
        }
        
        public System.Threading.Tasks.Task SubmitReviewAsync(int movieId, MovieWebApplication.MovieServiceReference.Review review) {
